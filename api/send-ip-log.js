export default async function handler(req, res) {
    ...
    try {
        ...
        console.log('Raw response from EmailJS:', responseText); // This will log the raw response as text
    
        // If the response is in JSON format, parse it
        let result;
        try {
            result = JSON.parse(responseText); // Try to parse the JSON response
        } catch (e) {
